...
class TestCurrencyCRUD:
    ...
    def test_get_currency_by_code(self, db_session):
        ...
        crud.create_currency(db_session, CurrencyCreate(code="JPY", full_name="Yen", sign="¥"))
    ...
    def test_get_all_currencies(self, db_session):
        ...
        crud.create_currency(db_session, CurrencyCreate(code="USD", full_name="US Dollar", sign="$"))
        crud.create_currency(db_session, CurrencyCreate(code="EUR", full_name="Euro", sign="€"))
...
class TestExchangeRateCRUD:
    ...
    def test_create_exchange_rate_success(self, db_session, sample_currencies):
        ...
        rate_data = ExchangeRateCreate(base_currency_code="USD", target_currency_code="EUR", rate=Decimal('0.92'))
    ...
    def test_create_exchange_rate_duplicate_pair(self, db_session, sample_currencies):
        ...
        duplicate = ExchangeRateCreate(base_currency_code="USD", target_currency_code="EUR", rate=Decimal('0.95'))
        with pytest.raises(IntegrityError):
    ...
    def test_create_exchange_rate_currency_not_found(self, db_session):
        ...
        rate_data = ExchangeRateCreate(base_currency_code="XXX", target_currency_code="EUR", rate=Decimal('0.92'))
    ...
    def test_get_exchange_rate_by_pair(self, db_session, sample_currencies):
        ...
        crud.create_exchange_rate(db_session, ExchangeRateCreate(base_currency_code="USD", target_currency_code="EUR", rate=Decimal('0.92')))
