...
class ExchangeRate(Base):
    ...
    __table_args__ = (
        UniqueConstraint('base_currency_id', 'target_currency_id', name='uq_currency_pair'),
    )
    ...
    def __repr__(self):
        return f"<ExchangeRate {self.base_currency.code}-> {self.target_currency.code}: {self.rate}>"
